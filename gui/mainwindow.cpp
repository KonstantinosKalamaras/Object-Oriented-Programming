...
/**************     Primary constructor     ***************/
MainWindow::MainWindow(BoardGame* boardGame, Player** players, Bank* bank, Deck* community, Deck* chance)
{
...
bool MainWindow::playerIsComputer(int playerId){
    return typeid(*players[playerId]) != typeid(HumanPlayer);
}
...
Card* MainWindow::getNextCommunityCard()
{
    return community->getNextCard();
}

Card* MainWindow::getNextChanceCard()
{
