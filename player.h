...
public:
    ...
    /**
     * Decides whether the player should buy the given space. This function has to be implemented in a derived class.
     *
     ...
     */
    virtual bool decideBuy(Space* space) = 0;

    /**
     * Decides whether the player should upgrade any of the owned properties. This function has to be implemented in a derived class.
     *
     * @return the space id of the property to be upgraded, or -1 in case the player does not want to upgrade any property.
     */
    virtual int decideUpgrade() = 0;
};
...
public:
    /**
     * Initializes this player object, by calling the player constructor.
     *
     * @param id the id of the player.
     */
    HumanPlayer(int id);
    ...
    /**
     * Decides whether the player should buy the given space (this function asks the human player).
     *
     * @param space pointer to space that is decided if the player wants to buy it.
     * @return true if the player wants to buy the space given, or false otherwise.
     */
    ...
    /**
     * Decides whether the player should upgrade any of the owned properties (this function asks the human player).
     *
     * @return the space id of the property to be upgraded, or -1 in case the player does not want to upgrade any property.
     */
    int decideUpgrade();
